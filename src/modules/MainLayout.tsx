        ...
        <div className="flex flex-col w-full h-full p-12">
            <header className="flex justify-between items-center gap-12">
                ...
                <nav className="flex flex-grow bg-[#E6E6E6] rounded-full px-4 justify-around mt-10 shadow-xl">
                    <Link
                        to="/home"
                        className="py-2 flex-grow text-center"
                        style={{ textDecoration: location.pathname === '/home' ? 'underline' : 'none' }}
                    >
                        HOME
                    </Link>
                    <Link
                        to="/ordenes"
                        className="py-2 flex-grow text-center"
                        style={{ textDecoration: location.pathname === '/ordenes' ? 'underline' : 'none' }}
                    >
                        ORDENES
                    </Link>
                    <Link
                        to="/inventario"
                        className="py-2 flex-grow text-center"
                        style={{ textDecoration: location.pathname === '/inventario' ? 'underline' : 'none' }}
                    >
                        INVENTARIO
                    </Link>
                </nav>
